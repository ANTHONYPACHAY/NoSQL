    ...
    public static String[] getDataToJwt(String jwt) {
        ...
        try {
            Claims claims = Jwts.parser()
                    .setSigningKey(DataStatic.userKey)
...
//            System.out.println(e.getMessage());
    ...
    public static String verifyUrl(String context, String directory, String foldername, String extension) {
        File fil = null;
        int count = -1;
        foldername = foldername.toLowerCase().replaceAll("[^a-zA-Z0-9\\s]+", "");
        do {
            count++;
    ...
    public static String[] validatePermit(String identifier, String permit, int flag) {
        String status = "6", message = "Sesión invalida.", data = "[]";
            ...
            switch (flag) {
                case 0:
                    if (permit.equals("S")) {// unequal // S
                        ...
                        status = "3";
                        message = "Su cuenta ya ha sido verificada.";
                        data = "[]";
                    }   break;
                case 1:
                    if (!permit.equals("S")) {// unequal // S
                ...
                case 2:
                    if (permit.equals("U") || permit.equals("A") || permit.equals("R")) {
                        ...
                        status = "3";
                        message = "Este contenido no esta disponible para ti.";
                        data = "[]";
                    }   break;
                case 3:
                ...
                case 4:
                    if (permit.equals("R")) {
                        ...
                        status = "3";
                        message = "Esta acción solo esta disponible para el Administrador.";
                        data = "[]";
                    }   break;
                default:
                    break;
