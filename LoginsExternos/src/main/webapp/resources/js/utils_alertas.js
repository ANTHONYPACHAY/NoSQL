...
function cardMap(identifier, nombre, calificacion) {
    let container = document.createElement('div');
    container.innerHTML = '<div class="card mb-3 row" style="min-width: 200px;margin-top: 15px; border-width:0px!important;">' +
            '<div class="row no-gutters">' +
            '<div class="col-md-4 abs-center" style="padding-top: 10px;padding-bottom: 10px;">' +
            '<img style="width:40px;height: 40px;"  src="resources/img/reacciones/' + calificacion.toFixed() + 'points.jpg" alt=""/>' +
            '</div>' +
            '<div class="col-md-8 abs-center">' +
            '<div class="card-body padding-zero">' +
            '<h6 class="text-muted margin-zero">' + nombre + '</h6>' +
            '<p class="card-text text-muted text-right"' +
            'style="font-size: 10px;padding-right: 5px;padding-top: 5px;">' +
            '<span class="badge badge-info" onclick="verpunto(' + identifier + ')"><span class="oi oi-eye"></span></span>&nbsp;&nbsp;&nbsp;' +
...
function cardMapRuta(identifier, nombre, calificacion) {
    let container = document.createElement('div');
    container.innerHTML = '<div class="card mb-3 row" style="min-width: 200px;margin-top: 15px; border-width:0px!important;">' +
            '<div class="row no-gutters">' +
            '<div class="col-md-4 abs-center" style="padding-top: 10px;padding-bottom: 10px;">' +
            ...
            '<p class="card-text text-muted text-right"' +
            'style="font-size: 10px;padding-right: 5px;padding-top: 5px;">' +
            '<span class="badge badge-info" onclick="verRuta(' + identifier + ')"><span class="oi oi-eye"></span></span>&nbsp;&nbsp;&nbsp;' +
            'calificación: ' + calificacion +
            '</p>' +
            '</div>' +
            '</div>' +
